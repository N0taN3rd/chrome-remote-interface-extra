...
class JSHandle {
  ...
  get type () {
    return this._remoteObject.type
  }

  get subtype () {
    return this._remoteObject.subtype
  }

  get description () {
    return this._remoteObject.description
  }
  ...
  call (...args) {
    assert(
      ...
      } - you must supply a function name to be called`
    )
...
class ElementHandle extends JSHandle {
  ...
  hasChildNodes () {
    return this.callFn('hasChildNodes')
  }
  ...
  async setAttribute (attribute, value) {
    await this.executionContext().evaluate(
      (elem, at, v) => elem.setAttribute(at, v),
      this,
      attribute,
      value
    )
