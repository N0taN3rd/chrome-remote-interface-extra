...
class FrameResourceTree {
  /**
   *
   * @param {CDPFrameResourceTree} resourceTree - Information about the Frame hierarchy along with their cached resources
  ...
  * walkTree () {
   ...
   * @param {CDPFrameResourceTree} resourceTree
   * @private
   */
