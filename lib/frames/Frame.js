...
class Frame {
  ...
  evaluateHandleWithCliAPI (pageFunction, ...args) {
    return this._mainWorld.evaluateHandleWithCliAPI(pageFunction, args, true)
  }
  ...
  evaluateWithCliAPI (pageFunction, ...args) {
    return this._mainWorld.evaluateHandleWithCliAPI(pageFunction, ...args)
  }
  ...
  /**
   * Returns a ElementHandle for this main frames document object
   * @return {Promise<ElementHandle>}
   */
  document () {
    return this._mainWorld.document()
  }

  /**
   * Returns a JSHandle for this main frames window object
   * @return {Promise<JSHandle>}
   */
  window () {
    return this._mainWorld.window()
  }
